        ...
        <section class="data-contain-right">
          <section class="right-item item-line right-one">
            ...
            <section class="risk-body">
              <div class="risk-left">
                <img class="risk-avatar" src="@/assets/avatar.png">
                <div class="risk-driver">
                  <div class="driver-p">
                    <span class="driver-title">昵称：</span>
                    <span class="driver-name" style="color: #fdd239">weYoung</span>
                  </div>
                  <div class="driver-p">
              ...
              <div class="risk-right">
                <div class="info-body">
                  <div class="info-item">
                    ...
                    <span class="info-item-content">2024-4-20 12:44</span>
                  </div>
                  <div class="info-item">
...
<script>
import LkChart from '@/components/admin/lk-chart.vue'
...
export default {
  ...
  components: { SmallIco, RevenueScrollCard, DataScrollCard, LkChart },
  data() {
    return {
      isFullscreen: false,
      // 各类图表数据
